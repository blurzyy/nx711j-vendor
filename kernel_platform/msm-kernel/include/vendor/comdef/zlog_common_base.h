...
#define ZLOG_MAX_MODULE_NAME_LEN	16
/* max ic name length */
...
#define ZLOG_CHG_VBAT_OVP			(256 | ZLOG_COMB_ERR_FLAG)
...
#define ZLOG_LCD_ESD_CHECK_ERROR_NO				(5 | ZLOG_COMB_ERR_FLAG)
...
#define ZLOG_FP_ENROLL_ERROR_NO 			(263 | ZLOG_COMB_ERR_FLAG)
...
#define ZLOG_BOOT_PWROFF_REASON_UNKNOWN              		(424 | ZLOG_COMB_ERR_FLAG)
...
/* UFS */
#define ZLOG_UFSHCD_ABORT_ERR					(256 | ZLOG_COMB_ERR_FLAG)
#define ZLOG_UFS_CMD_TIMEOUT_ERR				(257 | ZLOG_COMB_ERR_FLAG)
